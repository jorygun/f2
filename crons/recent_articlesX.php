...
$recent_articles = REPO_PATH . '/public/news/news_latest/recent_articles.html';

$lastest_ts = trim(file_get_contents(REPO_PATH . "/public/news/last_published_ts.txt"));
   ...
   # echo $sql . BRNL;
    ...
    if ($rowc == 0) {
     ...
     $report .= "
        ...
        <th>Comments</th><th>Link Clicks<th>Interesting?</th></tr>
        ";
      while ($row = $pst->fetch()) {
      	$article_id = $row['id'];
