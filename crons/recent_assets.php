...
function report_recent_assets ($pst,$rowc,$cutoff) {
    ...
    */
    ...
    $report .= "<p style='font-size:0.9em;'>(This list shows archival assets (tagged *) only, not all assets.  Find any asset on the site by using Search &gt; Search Graphics/Video. 'Multimedia' means streaming audio/video. )</p>";
