...
$messenger->sendLogins('john@digitalmx.com','here is the text from sender for email at '. date('H:i') );
echo "Sending to the user id" . BRNL;

$messenger->sendLogins(11602,'here is the text from sender for uid at ' . date('H:i') );
